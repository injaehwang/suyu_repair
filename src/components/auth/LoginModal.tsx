            ...
            <DialogContent className="sm:max-w-md bg-white p-0 gap-0 overflow-hidden rounded-3xl border-0 shadow-2xl">
                <div className="p-8 pt-10 text-center">
                    <DialogHeader className="mb-6">
                        <DialogTitle className="text-2xl font-bold text-center mb-2">로그인</DialogTitle>
                    ...
                    <div className="space-y-3">
                        ...
                        <Button
                            variant="outline"
                            className="w-full h-14 rounded-full border-slate-200 hover:bg-slate-50 justify-start px-6 gap-4 text-slate-700 font-medium relative overflow-hidden group transition-all"
                        ...
                        {/* Naver Button */}
                        <Button
                            className="w-full h-14 rounded-full bg-[#03C75A] hover:bg-[#02b351] text-white justify-start px-6 gap-4 font-bold relative overflow-hidden group transition-all"
                        ...
                        >
                            ...
                            <span className="flex-1 text-center">Naver로 계속하기</span>
                            {isLoading === 'naver' && (
